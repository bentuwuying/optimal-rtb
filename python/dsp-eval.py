...
constParas = list(range(2, 20, 2)) + list(range(20, 100, 5)) + list(range(100, 301, 10))  #[2, 4, 6, 8, 10, 20, 30, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300]
randParas = list(range(2, 20, 2)) + list(range(20, 100, 5)) + list(range(100, 501, 10))  #[5, 10, 20, 30, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 350, 400, 450, 500]
mcpcParas = [1]
linParas = list(range(2, 20, 2)) + list(range(20, 200, 5)) + list(range(200, 300, 10)) + list(range(300, 501, 25)) # [10, 15, 20, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 220, 250, 270, 300, 350, 400, 450, 500]
